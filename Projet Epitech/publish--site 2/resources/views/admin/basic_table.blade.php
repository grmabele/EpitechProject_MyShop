  ...
  <section id="container">
    ...
    <header class="header black-bg">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="../index.blade.php#">See all messages
                  </a>
              </li>
            </ul>
          </li>
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li>
            <a class="logout" href="login.blade.php">Logout</a>
          </li>
        </ul>
      </div>
    </header>
            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    <td>
                      <a href="basic_table.blade.php#">Company Ltd</a>
                    </td>
                  ...
                  <tr>
                    <td>
                      <a href="basic_table.blade.php#">Dashio ext</a>
                    </td>
                    <td class="hidden-phone">Lorem Ipsum dolor</td>
                    <td>22000.50$ </td>
                    <td><span class="label label-success label-mini">Paid</span></td>
                  ...
                  <tr>
                    <td>
                      <a href="basic_table.blade.php#">Total Ltd</a>
                    </td>
                    <td class="hidden-phone">Lorem Ipsum dolor</td>
                    <td>12120.00$ </td>
                    <td><span class="label label-warning label-mini">Due</span></td>
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="basic_table.blade.php#" class="go-top">
